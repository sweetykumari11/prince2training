                        ...
                        <div class="card-body">
                            <form method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" class="summernote @error('who_should_attend') is-invalid @enderror" name="who_should_attend">{{ old('who_should_attend', $topicdetail->who_should_attend) }}</textarea>
